...
struct FMcpClashMobChallengeEvent
{
	...
	struct FString                                     visible_date;                                     		// 0x0020 (0x0010) [0x0000000000000000]              
	struct FString                                     start_date;                                       		// 0x0030 (0x0010) [0x0000000000000000]              
	struct FString                                     end_date;                                         		// 0x0040 (0x0010) [0x0000000000000000]              
	struct FString                                     completed_date;                                   		// 0x0050 (0x0010) [0x0000000000000000]              
	struct FString                                     purge_date;                                       		// 0x0060 (0x0010) [0x0000000000000000]              
	int                                                repeat_after_days;                                		// 0x0070 (0x0004) [0x0000000000000000]              
	int                                                repeat_count;                                     		// 0x0074 (0x0004) [0x0000000000000000]              
	struct FString                                     challenge_type;                                   		// 0x0078 (0x0010) [0x0000000000000000]              
	...
	TArray< struct FMcpClashMobChallengeFile >         file_list;                                        		// 0x00A0 (0x0010) [0x0000000000000000]              
	struct FMcpClashMobPushNotification                start_notification;                               		// 0x00B0 (0x0044) [0x0000000000000000]              
	struct FMcpClashMobPushNotification                end_notification;                                 		// 0x00F4 (0x0044) [0x0000000000000000]              
	int                                                facebook_likes;                                   		// 0x0138 (0x0004) [0x0000000000000000]              
	struct FString                                     facebook_comments;                                		// 0x013C (0x0010) [0x0000000000000000]              
	...
	struct FString                                     facebook_id;                                      		// 0x015C (0x0010) [0x0000000000000000]              
	struct FString                                     facebook_post_message;                            		// 0x016C (0x0010) [0x0000000000000000]              
	...
	struct FString                                     twitter_id;                                       		// 0x018C (0x0010) [0x0000000000000000]              
	struct FString                                     twitter_message;                                  		// 0x019C (0x0010) [0x0000000000000000]              
...
struct FMcpClashMobChallengeUserStatus
{
	...
	struct FString                                     facebook_like_time;                               		// 0x0054 (0x0010) [0x0000000000000000]              
	...
	struct FString                                     twitter_retweet_time;                             		// 0x0068 (0x0010) [0x0000000000000000]              
...
struct FMcpMessage
{
	...
	struct FString                                     ToUniqueUserId;                                   		// 0x0020 (0x0010) [0x0000000000000000]              
	struct FString                                     FromUniqueUserId;                                 		// 0x0030 (0x0010) [0x0000000000000000]              
	struct FString                                     FromFriendlyName;                                 		// 0x0040 (0x0010) [0x0000000000000000]              
	struct FString                                     MessageType;                                      		// 0x0050 (0x0010) [0x0000000000000000]              
...
struct FMcpUserStatus
{
	...
	struct FString                                     CountryCode;                                      		// 0x0020 (0x0010) [0x0000000000000000]              
	struct FString                                     LastActiveDate;                                   		// 0x0030 (0x0010) [0x0000000000000000]              
...
struct FRegisterUserRequest
{
	...
	struct FString                                     McpId;                                            		// 0x0010 (0x0010) [0x0000000000000000]              
...
struct FEventUploadConfig
{
	...
	unsigned long                                      bUseCompression : 1;                              		// 0x0018 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FNewsCacheEntry
{
	...
	unsigned long                                      bIsUnicode : 1;                                   		// 0x0028 (0x0004) [0x0000000000000000] [0x00000001] 
