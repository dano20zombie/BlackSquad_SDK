...
struct FMcpClashMobChallengeEvent
{
	...
	struct FString                                     visible_date;                                     		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     start_date;                                       		// 0x0030 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     end_date;                                         		// 0x0040 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     completed_date;                                   		// 0x0050 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     purge_date;                                       		// 0x0060 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                repeat_after_days;                                		// 0x0070 (0x0004) [0x0000000000000000]              
	int                                                repeat_count;                                     		// 0x0074 (0x0004) [0x0000000000000000]              
	struct FString                                     challenge_type;                                   		// 0x0078 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                num_attempts;                                     		// 0x0088 (0x0004) [0x0000000000000000]              
	int                                                num_successful_attempts;                          		// 0x008C (0x0004) [0x0000000000000000]              
	int                                                goal_value;                                       		// 0x0090 (0x0004) [0x0000000000000000]              
	int                                                goal_start_value;                                 		// 0x0094 (0x0004) [0x0000000000000000]              
	int                                                goal_current_value;                               		// 0x0098 (0x0004) [0x0000000000000000]              
	unsigned long                                      has_started : 1;                                  		// 0x009C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      is_visible : 1;                                   		// 0x009C (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      has_completed : 1;                                		// 0x009C (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      was_successful : 1;                               		// 0x009C (0x0004) [0x0000000000000000] [0x00000008] 
	TArray< struct FMcpClashMobChallengeFile >         file_list;                                        		// 0x00A0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FMcpClashMobPushNotification                start_notification;                               		// 0x00B0 (0x0044) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FMcpClashMobPushNotification                end_notification;                                 		// 0x00F4 (0x0044) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                facebook_likes;                                   		// 0x0138 (0x0004) [0x0000000000000000]              
	struct FString                                     facebook_comments;                                		// 0x013C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              facebook_like_scaler;                             		// 0x014C (0x0004) [0x0000000000000000]              
	float                                              facebook_comment_scaler;                          		// 0x0150 (0x0004) [0x0000000000000000]              
	int                                                facebook_like_goal_progress;                      		// 0x0154 (0x0004) [0x0000000000000000]              
	int                                                facebook_comment_goal_progress;                   		// 0x0158 (0x0004) [0x0000000000000000]              
	struct FString                                     facebook_id;                                      		// 0x015C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     facebook_post_message;                            		// 0x016C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      wants_facebook_posting : 1;                       		// 0x017C (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                twitter_retweets;                                 		// 0x0180 (0x0004) [0x0000000000000000]              
	float                                              twitter_retweets_scaler;                          		// 0x0184 (0x0004) [0x0000000000000000]              
	int                                                twitter_goal_progress;                            		// 0x0188 (0x0004) [0x0000000000000000]              
	struct FString                                     twitter_id;                                       		// 0x018C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     twitter_message;                                  		// 0x019C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      wants_twitter_posting : 1;                        		// 0x01AC (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FMcpClashMobChallengeUserStatus
{
	...
	struct FString                                     facebook_like_time;                               		// 0x0054 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      enrolled_via_facebook : 1;                        		// 0x0064 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      liked_via_facebook : 1;                           		// 0x0064 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      commented_via_facebook : 1;                       		// 0x0064 (0x0004) [0x0000000000000000] [0x00000004] 
	struct FString                                     twitter_retweet_time;                             		// 0x0068 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      enrolled_via_twitter : 1;                         		// 0x0078 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      retweeted : 1;                                    		// 0x0078 (0x0004) [0x0000000000000000] [0x00000002] 
};
...
struct FMcpMessage
{
	...
	struct FString                                     TitleId;                                          		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     ToUniqueUserId;                                   		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     FromUniqueUserId;                                 		// 0x0030 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     FromFriendlyName;                                 		// 0x0040 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     MessageType;                                      		// 0x0050 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     ValidUntil;                                       		// 0x0060 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      MessageCompressionType;                           		// 0x0070 (0x0001) [0x0000000000000000]              
};
...
{
	struct FString                                     McpId;                                            		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     UDID;                                             		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     CountryCode;                                      		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     LastActiveDate;                                   		// 0x0030 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                DaysInactive;                                     		// 0x0040 (0x0004) [0x0000000000000000]              
...
{
	struct FString                                     UDID;                                             		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
