...
{
	class UProperty*                                   Property;                                         		// 0x0000 (0x0008) [0x0000000000100000]              
	int                                                ArrayIndex;                                       		// 0x0008 (0x0004) [0x0000000000100000]              
};
...
{
	struct FString                                     PropertyName;                                     		// 0x0000 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	float                                              RelevantDelayTime;                                		// 0x0010 (0x0004) [0x0000000000100000]              
	float                                              FrontSideCheckDelayDelta;                         		// 0x0014 (0x0004) [0x0000000000100000]              
	struct FMap_Mirror                                 LastUpdateInfo;                                   		// 0x0018 (0x0048) [0x0000000000103002]              ( CPF_Const | CPF_Native | CPF_Transient )
};
...
struct FTraceHitInfo
{
	...
	int                                                BoneIndex;                                        		// 0x0020 (0x0004) [0x0000000000100000]              
	class UPrimitiveComponent*                         HitComponent;                                     		// 0x0024 (0x0008) [0x0000000004180008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
};
...
struct FImpactInfo
{
	...
	struct FTraceHitInfo                               HitInfo;                                          		// 0x0038 (0x002C) [0x0000000000180000]              ( CPF_Component )
};
...
struct FOutlineProperty
{
	...
	float                                              IntenseCycleTime;                                 		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ColorIntense;                                     		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              WidthMaxDistance;                                 		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CullDistance;                                     		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      Color;                                            		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     OverrideMaterialName;                             		// 0x001C (0x0010) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UMaterialInterface*                          OverrideMaterial;                                 		// 0x002C (0x0008) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      Width;                                            		// 0x0034 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      MinWidth;                                         		// 0x0035 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      BlendMode;                                        		// 0x0036 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      StencilID;                                        		// 0x0037 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bUseOriginalMaterial : 1;                         		// 0x0038 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bSuppressOtherOutline : 1;                        		// 0x0038 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      DrawOnlyHidden : 1;                               		// 0x0038 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      DisableDepthTest : 1;                             		// 0x0038 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      EnableDepthWrite : 1;                             		// 0x0038 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bOverlaySurface : 1;                              		// 0x0038 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bDisableForeground : 1;                           		// 0x0038 (0x0004) [0x0000000000000001] [0x00000040] ( CPF_Edit )
};
...
struct FPostProcessSettings
{
	...
	struct FMobilePostProcessSettings                  MobilePostProcess;                                		// 0x012C (0x0038) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FSeqOpOutputLink
{
	...
	unsigned long                                      bIsActivated : 1;                                 		// 0x0034 (0x0004) [0x0000000001002000] [0x00000010] ( CPF_Transient )
};
...
struct FSingleChannelSound
{
	...
	class UAudioComponent*                             AudioComponent;                                   		// 0x0008 (0x0008) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
...
struct FKConvexElem
{
	TArray< struct FVector >                           VertexData;                                       		// 0x0000 (0x0010) [0x0000000000520001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
	TArray< struct FPlane >                            PermutedVertexData;                               		// 0x0010 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< int >                                      FaceTriData;                                      		// 0x0020 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FVector >                           EdgeDirections;                                   		// 0x0030 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FVector >                           FaceNormalDirections;                             		// 0x0040 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FPlane >                            FacePlaneData;                                    		// 0x0050 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
{
	TArray< struct FKSphereElem >                      SphereElems;                                      		// 0x0000 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FKBoxElem >                         BoxElems;                                         		// 0x0010 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FKSphylElem >                       SphylElems;                                       		// 0x0020 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FKConvexElem >                      ConvexElems;                                      		// 0x0030 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
struct FPreviewSkelMeshStruct
{
	...
	TArray< class USkeletalMesh* >                     PreviewSkelMesh;                                  		// 0x0008 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UMorphTargetSet* >                   PreviewMorphSets;                                 		// 0x0018 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FPreviewSocketEntryStruct
{
	...
	class UObject*                                     PreviewMesh;                                      		// 0x0008 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UAnimSet*                                    AnimsetToUse;                                     		// 0x0010 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       BaseSequenceName;                                 		// 0x0018 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	struct FName                                       DisplayName;                                      		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FPreviewSocketEntryStruct >         Attachments;                                      		// 0x0008 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                RelatedPreviewAnimsetIndex;                       		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FTextureGroupContainer
{
	...
	unsigned long                                      TEXTUREGROUP_WorldCubeMap : 1;                    		// 0x0000 (0x0004) [0x0000000000000003] [0x10000000] ( CPF_Edit | CPF_Const )
};
...
struct FLoadingCompUserData
{
	...
	struct FString                                     ClanName;                                         		// 0x0014 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	int                                                CoverIndex;                                       		// 0x0024 (0x0004) [0x0000000000000000]              
	struct FString                                     ClanImage;                                        		// 0x0028 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     RankImage;                                        		// 0x0038 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     TierImage;                                        		// 0x0048 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     CallingCardURL;                                   		// 0x0058 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
{
	struct FString                                     Title;                                            		// 0x0000 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     MapName;                                          		// 0x0010 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ModeName;                                         		// 0x0020 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     Tip;                                              		// 0x0030 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     BGImgPath;                                        		// 0x0040 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     MinimapImgPath;                                   		// 0x0050 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	...
	struct FString                                     ClanMatchClanName_Left;                           		// 0x0064 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanName_Right;                          		// 0x0074 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanEmblemPath_Left;                     		// 0x0084 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanEmblemPath_Right;                    		// 0x0094 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanLevel_Left;                          		// 0x00A4 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanLevel_Right;                         		// 0x00B4 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanLevelColor_Left;                     		// 0x00C4 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanLevelColor_Right;                    		// 0x00D4 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchAdvantage_Left;                          		// 0x00E4 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchAdvantage_Right;                         		// 0x00F4 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	...
	struct FString                                     CompMatchTeamName_Left;                           		// 0x0110 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     CompMatchTeamName_Right;                          		// 0x0120 (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	...
	TArray< struct FLoadingCompUserData >              CompMatchLeftUsers;                               		// 0x013C (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FLoadingCompUserData >              CompMatchRightUsers;                              		// 0x014C (0x0010) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FWorldCube
{
	class UTextureCube*                                TextureCube;                                      		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
{
	struct FColor                                      LightmapColor;                                    		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LightmapBrightness;                               		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LightmapDesaturation;                             		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      MinLightmapFactor;                                		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      MinShadowFactor;                                  		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Desaturation;                                     		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	class AActor*                                      PreviousTickableActor;                            		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class AActor*                                      PostTickableActor;                                		// 0x0008 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	TArray< class AActor* >                            ActorList;                                        		// 0x0000 (0x0010) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	float                                              LitIndirectBrightness;                            		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LitIndirectContrastFactor;                        		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ShadowedIndirectBrightness;                       		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ShadowedIndirectContrastFactor;                   		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LightingContrastFactor;                           		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LightingDesaturation;                             		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FLandscapeLayerStruct
{
	...
	unsigned long                                      bSelected : 1;                                    		// 0x0008 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
};
...
{
	struct FPostProcessSettings                        Settings;                                         		// 0x0000 (0x0164) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	struct FInterpCurveFloat                           TimeAlphaCurve;                                   		// 0x017C (0x0014) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	struct FPostProcessSettings                        LastSettings;                                     		// 0x0000 (0x0164) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FSkeletalMeshLODInfo
{
	...
	float                                              DisplayFactor;                                    		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LODHysteresis;                                    		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< int >                                      LODMaterialMap;                                   		// 0x000C (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< unsigned long >                            bEnableShadowCasting;                             		// 0x001C (0x0010) [0x0000000000400041]              ( CPF_Edit | CPF_EditConstArray | CPF_NeedCtorLink )
	TArray< unsigned char >                            TriangleSorting;                                  		// 0x002C (0x0010) [0x0000000020400000]              ( CPF_NeedCtorLink | CPF_Deprecated )
	TArray< struct FTriangleSortSettings >             TriangleSortSettings;                             		// 0x003C (0x0010) [0x0000000000400041]              ( CPF_Edit | CPF_EditConstArray | CPF_NeedCtorLink )
	unsigned long                                      bDisableCompressions : 1;                         		// 0x004C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
struct FMaterialSet
{
	...
	TArray< int >                                      MaterialPackageIndex;                             		// 0x0010 (0x0010) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	TArray< struct FString >                           PackageName;                                      		// 0x0020 (0x0010) [0x0000000000422000]              ( CPF_Transient | CPF_EditConst | CPF_NeedCtorLink )
};
...
struct FStaticMeshLODElement
{
	...
	TArray< class UMaterialInterface* >                MaterialSetList;                                  		// 0x0008 (0x0010) [0x0000000000001001]              ( CPF_Edit | CPF_Native )
	TArray< int >                                      MaterialSetPackageIndex;                          		// 0x0018 (0x0010) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	TArray< struct FName >                             MaterialSetPackageName;                           		// 0x0028 (0x0010) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	unsigned long                                      bEnableShadowCasting : 1;                         		// 0x0038 (0x0004) [0x0000000000001001] [0x00000001] ( CPF_Edit | CPF_Native )
	unsigned char                                      UnknownData00[ 0x4 ];                             		// 0x003C (0x0004) MISSED OFFSET
	unsigned long                                      bEnableCollision : 1;                             		// 0x0040 (0x0004) [0x0000000000001001] [0x00000001] ( CPF_Edit | CPF_Native )
};
