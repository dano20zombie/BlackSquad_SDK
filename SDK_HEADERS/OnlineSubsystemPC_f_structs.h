...
struct UOnlineSubsystemPC_execReadAchievements_Parms
{
	...
	// unsigned long                                   bShouldReadText : 1;                              		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bShouldReadImages : 1;                            		// 0x000C (0x0004) [0x0000000000000000] [0x00000001] 
...
{
	// unsigned char                                   LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000000]              
	// unsigned long                                   bAllowFriends : 1;                                		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   ReturnValue : 1;                                  		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	// unsigned char                                   LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000000]              
	// TArray< struct FUniqueNetId >                   Friends;                                          		// 0x0004 (0x0010) [0x0000000000000000]              
...
struct UOnlineSubsystemPC_execSendGameInviteToFriend_Parms
{
	// unsigned char                                   LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000000]              
	// struct FUniqueNetId                             Friend;                                           		// 0x0004 (0x0008) [0x0000000000000000]              
	// struct FString                                  Text;                                             		// 0x000C (0x0010) [0x0000000000000000]              
...
{
	// unsigned char                                   LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000000]              
	// unsigned long                                   bWasSuccessful : 1;                               		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UOnlineSubsystemPC_execShowKeyboardUI_Parms
{
	...
	// unsigned long                                   bIsPassword : 1;                                  		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   bShouldValidate : 1;                              		// 0x0028 (0x0004) [0x0000000000000000] [0x00000001] 
	// struct FString                                  DefaultText;                                      		// 0x002C (0x0010) [0x0000000000000000]              
	// int                                             MaxResultLength;                                  		// 0x003C (0x0004) [0x0000000000000000]              
	// unsigned long                                   ReturnValue : 1;                                  		// 0x0040 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	// unsigned char                                   LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000000]              
	// int                                             StatusId;                                         		// 0x0004 (0x0004) [0x0000000000000000]              
	// TArray< struct FLocalizedStringSetting >        LocalizedStringSettings;                          		// 0x0008 (0x0010) [0x0000000000000000]              
	// TArray< struct FSettingsProperty >              Properties;                                       		// 0x0018 (0x0010) [0x0000000000000000]              
};
...
{
	// int                                             ControllerId;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	// unsigned long                                   bIsConnected : 1;                                 		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	// unsigned long                                   bIsOpening : 1;                                   		// 0x0000 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	// unsigned long                                   bIsConnected : 1;                                 		// 0x0000 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	// class UOnlineStatsRead*                         StatsRead;                                        		// 0x0000 (0x0008) [0x0000000000000000]              
	// int                                             StartIndex;                                       		// 0x0008 (0x0004) [0x0000000000000000]              
	// int                                             NumToRead;                                        		// 0x000C (0x0004) [0x0000000000000000]              
	// unsigned long                                   ReturnValue : 1;                                  		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UOnlineSubsystemPC_execReadOnlineStats_Parms
{
	...
	// class UOnlineStatsRead*                         StatsRead;                                        		// 0x0010 (0x0008) [0x0000000000000000]              
	// unsigned long                                   ReturnValue : 1;                                  		// 0x0018 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UOnlineSubsystemPC_execUnmuteRemoteTalker_Parms
{
	...
	// unsigned long                                   bIsSystemWide : 1;                                		// 0x000C (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   ReturnValue : 1;                                  		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UOnlineSubsystemPC_execReadFriendsList_Parms
{
	...
	// struct FScriptDelegate                          CallDelegate;                                     		// 0x0014 (0x0010) [0x0000000000000000]              
};
...
{
	// unsigned char                                   LocalUserNum;                                     		// 0x0000 (0x0001) [0x0000000000000000]              
	// struct FScriptDelegate                          LoginDelegate;                                    		// 0x0004 (0x0010) [0x0000000000000000]              
};
...
struct UOnlineSubsystemPC_execLogin_Parms
{
	...
	// unsigned long                                   bWantsLocalOnly : 1;                              		// 0x0024 (0x0004) [0x0000000000000000] [0x00000001] 
...
{
	// unsigned long                                   bShowOnlineOnly : 1;                              		// 0x0000 (0x0004) [0x0000000000000000] [0x00000001] 
	// unsigned long                                   ReturnValue : 1;                                  		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UOnlineSubsystemPC_execOnPlayerTalkingStateChange_Parms
{
	...
	// unsigned long                                   bIsTalking : 1;                                   		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
};
